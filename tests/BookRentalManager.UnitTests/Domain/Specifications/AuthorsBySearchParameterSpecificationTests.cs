...
public sealed class AuthorsBySearchParameterSpecificationTests
{
    ...
    public void IsSatisfiedBy_WithAuthorsWithQuery_ReturnsTrue(string searchParameter, Author author)
    {
        // Arrange:
        var authorsWithSearchParameterSpecification = new AuthorsBySearchParameterSpecification(searchParameter);
    ...
    public void IsSatisfiedBy_WithoutAuthorsWithQuery_ReturnsFalse(string searchParameter, Author author)
    {
        // Arrange:
        var authorsWithSearchParameterSpecification = new AuthorsBySearchParameterSpecification(searchParameter);
