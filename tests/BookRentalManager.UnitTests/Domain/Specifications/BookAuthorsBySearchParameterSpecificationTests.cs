...
public sealed class BookAuthorsBySearchParameterSpecificationTests
{
    ...
    {
        // Arrange:
        var bookAuthorsWithSearchParameterSpecification = new BookAuthorsBySearchParameterSpecification(searchParameter);
