...
public sealed class BooksFromAuthorBooksByQueryParameterSpecification : Specification<Book>
{
    public BooksFromAuthorBooksByQueryParameterSpecification(IReadOnlyList<Book> books, string searchParameter)
    {
