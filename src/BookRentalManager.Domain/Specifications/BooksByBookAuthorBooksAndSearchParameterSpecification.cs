...
public sealed class BooksByBookAuthorBooksAndSearchParameterSpecification : Specification<Book>
{
    public BooksByBookAuthorBooksAndSearchParameterSpecification(IReadOnlyList<Book> books, string searchParameter)
    {
