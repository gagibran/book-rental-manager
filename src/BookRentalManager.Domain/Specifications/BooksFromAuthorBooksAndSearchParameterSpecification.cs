...
public sealed class BooksFromAuthorBooksAndSearchParameterSpecification : Specification<Book>
{
    public BooksFromAuthorBooksAndSearchParameterSpecification(IReadOnlyList<Book> books, string searchParameter)
    {
