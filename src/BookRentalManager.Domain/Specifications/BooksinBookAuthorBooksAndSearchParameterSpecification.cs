...
public sealed class BooksInBookAuthorBooksAndSearchParameterSpecification : Specification<Book>
{
    public BooksInBookAuthorBooksAndSearchParameterSpecification(IReadOnlyList<Book> books, string searchParameter)
    {
